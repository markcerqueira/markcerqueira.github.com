...
task :post do
  ...
  # posts folder is organized by year so append Date.today.year to destination
  filename = File.join(CONFIG['posts'] + '/' + Date.today.year.to_s, "#{date}-#{slug}.#{CONFIG['post_ext']}")
...
GITHUB_REPONAME = "markcerqueira/markcerqueira.github.com"
